...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const API_URL = "http://127.0.0.1:8080/calculate"; // Make sure backend is running
  ...
  computeBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      resultTextarea.value = "Error: Could not connect to the calculation server. Is it running?";
    }
  });
